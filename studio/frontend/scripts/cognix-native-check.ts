...
const checks: Check[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      '"training_local_available"',
      '"training_cloud_available"',
      '"training_local_gpu_required"',
      '"training_local_gpu_bypass_allowed"',
      '"training_default_cloud_target"',
      "CLOUD_TRAINING_PROVIDERS",
  ...
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "PromptCachePlanRequest",
      '@router.post("/optimizations/prompt-cache-plan")',
      "cognix_prompt_cache.build_prompt_cache_plan",
      "prompt_cache_plan_built",
      '"cognix_prompt_cache_plan"',
    ],
  },
  {
    file: "../backend/routes/cognix.py",
  ...
  },
  {
    ...
    includes: [
      ...
      "class ModelCachePressurePlanRequest",
      ...
      "class ExpertGeneralistQualityGateRequest",
      ...
      "class ConversationSummaryPlanRequest",
      ...
      "integration_secret_rotation_contract_built",
      ...
      "rag_connector_sync_plan_built",
      "rag_indexing_plan_built",
      "rag_plan_built",
      "module_manifest_bundle_built",
      "module_service_topology_built",
      "module_plan_built",
      ...
      "_iter_registered_api_routes",
      "original_router",
      "include_context",
      "codex_pipeline_plan_built",
      "nightModeContractVersion",
  ...
  {
    file: "../backend/core/cognix/sensitive_audit.py",
    includes: [
  ...
  },
  {
    ...
    includes: [
      ...
      "def _ensure_global_roadmap_tables",
      "def _ensure_project_skill_directive_columns",
      '"enterprise_chats"',
      '"project_directives"',
      '"notifications"',
      ...
      '"audit_integrity_retention_dry_run"',
      '"sha256_previous_hash_chain"',
      '"metadataJsonReturnedInContract": False',
      "def create_audit_log",
      "def list_audit_logs",
      "def prune_audit_logs",
      "def _ensure_sensitive_action_log_columns",
  ...
  {
    file: "../backend/core/cognix/notifications.py",
    includes: [
  ...
  },
  {
    ...
    includes: [
      ...
      "executionBoundaryContractRequired",
      "executionBoundaryContractVersion",
      "pre_executor_boundary",
      "executorMustRecheckBoundary",
      "RATE_LIMIT_POLICIES",
      '"calculator:evaluate"',
      '"physics:solve"',
      '"latex:render"',
  ...
  {
    file: "../backend/core/cognix/database_blueprint.py",
    includes: [
      'COGNIX_DATABASE_BLUEPRINT_VERSION = "cognix_database_blueprint_v1"',
      "ROADMAP_TABLES",
      "GLOBAL_ROADMAP_TABLE_NAMES",
      '"v2_sections_42_global_tables"',
      "def build_database_blueprint",
      "def _global_table_record",
      '"database_blueprint_read_only"',
      '"roadmap_section_27"',
      '"globalRoadmapTables"',
      '"globalCoverage"',
      '"readyForV2GlobalSchema"',
      '"users"',
      '"workspaces"',
      '"organizations"',
      '"plans"',
  ...
  {
    file: "../backend/core/cognix/mvp_readiness.py",
    includes: [
      'COGNIX_MVP_READINESS_VERSION = "cognix_mvp_readiness_v1"',
      "MVP_PHASES",
      "def build_mvp_readiness_contract",
      '"mvp_readiness_read_only"',
      '"roadmap_section_31"',
      '"phase_1_core_local"',
      '"phase_2_specialized_projects"',
      '"phase_3_orchestrator"',
      '"phase_4_model_cache_manager"',
      '"phase_5_rag"',
      '"phase_6_guided_fine_tuning"',
      '"phase_7_connectors"',
      '"phase_8_enterprise"',
      '"phase_9_native_codex_secure"',
  ...
  },
  {
    ...
    includes: [
      ...
      '"secret_rotation_contract_dry_run"',
      '"frontendDirectSecretRotationAllowed": False',
      '"secretRotation": False',
      '"connector_roadmap_readiness_dry_run"',
      '"roadmap_phase_7_connectors"',
      '"google-drive"',
      '"microsoft-365"',
      '"slack-teams"',
      '"readyForMvpConnectorLayer"',
  ...
  },
  {
    ...
    includes: [
      ...
      '"tokens_daily"',
      '"cloud_model_access"',
      '"tokens_daily_quota_exceeded"',
      '"cloud_model_access_quota_blocked"',
      '"guardedDecision"',
  ...
  {
    file: "../backend/core/cognix/prompt_cache.py",
    includes: [
  ...
  },
  {
    ...
    includes: [
      ...
      '"codex_night_report_contract_dry_run"',
      '"readyForHumanValidation"',
      '"requiredSections"',
      '"missingRequiredSections"',
      '"reportWrite": False',
      '"autonomousNightWorkAllowed"',
      '"visibleProductChangeRequested"',
      '"create_git_branch"',
  ...
  },
  {
    ...
    includes: [
      ...
      '"preloadAction"',
      '"routerFallbackChainVersion"',
      '"routerFallbackStatus"',
  ...
  },
  {
    ...
    includes: [
      ...
      "def build_vulnerability_scanner_adapter_contract",
      '"vulnerability_scanner_adapter_read_only"',
      '"python_dependencies"',
      '"node_dependencies"',
      '"cloud_training_dependencies"',
  ...
  },
  {
    ...
    includes: [
      ...
      "def build_rag_plan",
      '"rag_connector_sync_contract_dry_run"',
      '"rag_connector_sync"',
  ...
  },
  {
    ...
    includes: [
      ...
      "test_cache_pressure_plan_prioritizes_idle_then_lru_without_unload",
      "test_cache_load_plan_endpoint_returns_audited_dry_run_plan",
      "test_cache_pressure_plan_endpoint_returns_audited_dry_run_plan",
      ...
      "/api/cognix/models/cache/pressure-plan",
      "cache_load_plan_built",
      "cache_pressure_plan_built",
      "/api/cognix/models/preload-plan",
      "preload_plan_built",
      "model_cache_manager_v1",
      "model_cache_pressure_plan_v1",
      "cognix_preload_planner_v1",
    ],
  },
  {
    file: "../backend/tests/test_cognix_project_models.py",
    includes: [
      "test_project_default_model_can_be_set_listed_read_and_deleted",
      "test_favorite_models_blueprint_declares_native_services_and_no_model_execution",
      "test_favorite_model_user_default_and_quick_switcher_are_native_and_audited",
      "test_project_default_model_updates_roadmap_table_and_quick_switcher",
      ...
      "cognix_db.get_project_model_default",
      "cognix_db.get_user_model_default",
      "cognix_db.list_favorite_models",
    ],
  },
  {
  ...
  },
  {
    ...
    includes: [
      ...
      "test_execution_budget_guard_blocks_cloud_without_quota_and_falls_back_without_provider_call",
      "test_execution_budget_guard_blocks_all_targets_when_daily_token_quota_is_exceeded",
      "test_cost_optimization_endpoint_stores_execution_cost_log_and_logs_audit",
      "test_cost_optimization_endpoint_applies_native_quota_guard_before_cloud_execution",
      ...
      "test_prompt_cache_plan_prepares_stable_prefix_without_runtime_mutation",
      "test_prompt_cache_plan_blocks_sensitive_prefix_without_raw_prompt_storage",
      "test_prompt_cache_plan_endpoint_logs_sanitized_contract_without_cache_io",
      ...
      "test_expert_generalist_quality_gate_recommends_review_without_second_model_call",
      "test_response_reflection_endpoint_stores_evaluation_and_logs_audit",
      "test_expert_generalist_quality_gate_endpoint_stores_metadata_and_audits",
      ...
      "test_conversation_summary_plan_caps_recent_messages_and_redacts_secrets_without_generation",
      "test_prompt_compression_endpoint_stores_lists_deletes_and_audits",
      "test_conversation_summary_endpoint_stores_redacted_summary_and_audits",
      ...
      "test_codex_night_mode_contract_allows_security_optimization_only",
      "test_codex_night_mode_contract_blocks_visible_feature_work",
      "test_codex_night_report_contract_requires_sections_without_writes",
      "test_codex_night_report_contract_blocks_incomplete_or_visible_work",
      "test_codex_night_report_endpoint_returns_dry_run_contract",
      "test_codex_pipeline_endpoint_logs_audited_dry_run",
      "test_codex_pipeline_endpoint_respects_night_mode_policy",
      ...
      "test_worker_job_spec_plan_materializes_connector_sync_without_network_or_enqueueing",
      "test_worker_job_spec_plan_materializes_tool_execution_handoff_without_enqueuing_or_payload_storage",
      ...
      "test_worker_job_spec_endpoint_accepts_connector_sync_plan_without_raw_filters",
      "test_worker_job_spec_endpoint_accepts_tool_execution_handoff_without_raw_payload",
      ...
      "test_audit_governance_contract_hashes_redacted_logs_without_mutation",
      "test_audit_governance_contract_endpoint_is_admin_only_and_read_only",
      "test_database_blueprint_maps_roadmap_tables_without_schema_mutation",
      "test_database_blueprint_endpoint_is_admin_only_and_read_only",
      "test_api_surface_contract_maps_roadmap_endpoints_without_route_mutation",
      "test_api_surface_contract_endpoint_is_admin_only_and_read_only",
      "test_mvp_readiness_contract_maps_roadmap_phases_without_mutation",
      "test_mvp_readiness_endpoint_is_admin_only_and_read_only",
      ...
      "test_module_service_topology_maps_roadmap_services_without_mutation",
      "test_module_manifest_endpoint_writes_sanitized_audit_log",
      "test_module_service_topology_endpoint_writes_sanitized_audit_log",
      ...
      "cognix_knowledge_strategy_contract_v1",
      "test_tool_registry_declares_permissions_and_guardrails",
      "test_tool_action_plan_builds_execution_boundary_contract_without_execution",
      ...
      "test_connector_roadmap_readiness_maps_mvp_connectors_without_execution",
      "test_connector_roadmap_readiness_endpoint_is_user_scoped_and_read_only",
      ...
      "test_secret_rotation_contract_recommends_high_risk_rotation_without_secret_io",
      "test_secret_rotation_contract_blocks_unknown_integration_without_secret_io",
      "test_secret_rotation_contract_endpoint_logs_sanitized_contract",
      ...
      "test_admin_security_center_builds_threat_risk_and_health",
      ...
      "test_ceo_cloud_training_access_does_not_require_local_amd_or_nvidia_gpu",
      ...
      "test_rag_connector_sync_plan_prepares_drive_handoff_without_network_or_secrets",
      "test_rag_connector_sync_plan_blocks_unknown_connector_without_side_effects",
      "test_rag_connector_sync_endpoint_logs_sanitized_contract",
      ...
      "test_router_fallback_chain_handles_ambiguous_experts_without_loading_models",
  ...
  {
    file: "../backend/tests/test_cognix_v2_surface_contracts.py",
    includes: [
      "test_v2_global_roadmap_tables_are_bootstrapped_with_common_contract_columns",
      "test_database_blueprint_reports_v2_global_table_coverage_without_changing_legacy_contract",
      "test_api_surface_reports_v2_product_navigation_routes",
      "GLOBAL_ROADMAP_TABLE_NAMES",
      "PRODUCT_NAVIGATION_ROUTES",
      '"enterprise_chats"',
      '"project_directives"',
  ...
  {
    file: "../backend/core/cognix/project_skills_directives.py",
    includes: [
      ...
      '"skill_examples"',
      '"directive_priorities"',
      "build_project_skill_plan",
      "build_skill_injection_plan",
      "build_project_directive_plan",
      "compile_project_directives",
      "permissionEscalationAllowed",
      '"security", "organization", "project", "user", "model_preference"',
    ],
  },
  {
    ...
    includes: [
      ...
      "test_chat_project_bridge_creates_project_from_discussion_and_shares_answer",
  ...
  {
    file: "../backend/core/cognix/skill_marketplace.py",
    includes: [
      "COGNIX_SKILL_MARKETPLACE_SERVICE_VERSION",
      "COGNIX_SKILL_APPROVAL_SERVICE_VERSION",
      "COGNIX_SKILL_VERSION_MANAGER_VERSION",
      ...
      '"skill_approvals"',
      '"skill_usage_logs"',
      "build_skill_publish_plan",
      "build_skill_usage_plan",
    ],
  },
  {
    file: "../backend/core/cognix/enterprise_chat.py",
    includes: [
  ...
  {
    file: "../backend/core/cognix/realtime_collaboration.py",
    includes: [
  ...
  {
    file: "../backend/core/cognix/favorite_models.py",
    includes: [
  ...
  {
    file: "../backend/core/cognix/agent_mode.py",
    includes: [
      ...
      '"agent_tool_calls"',
      '"agent_outputs"',
      "def build_agent_mode_blueprint",
  ...
  {
    file: "../backend/core/cognix/cowork.py",
    includes: [
  ...
  },
  {
    ...
    includes: [
      ...
      "def create_enterprise_chat",
      "def get_enterprise_chat",
      "def list_enterprise_chats",
      "def create_enterprise_encrypted_message",
      "def list_enterprise_encrypted_messages",
      '"collaboration_events"',
      "def get_project_collaborator",
      "def upsert_project_presence",
      "def list_project_presence_sessions",
      ...
      '"user_model_defaults"',
      '"project_model_defaults"',
      "def upsert_favorite_model",
      "def list_favorite_models",
      "def delete_favorite_model",
      "def set_user_model_default",
      "def get_user_model_default",
      "def delete_user_model_default",
      "def _upsert_project_model_default_record",
      '"agent_outputs"',
      "def create_agent_mode_session",
      "def get_agent_mode_session",
      "def list_agent_mode_sessions",
      "def update_agent_mode_step",
      "def create_agent_tool_call_plan",
      "def create_agent_output",
      '"cowork_approvals"',
      "def create_cowork_session",
      "def get_cowork_session",
      "def list_cowork_sessions",
      "def update_cowork_session_status",
      "def create_cowork_action",
      "def list_cowork_actions",
    ],
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_cowork",
      "cognix_agent_mode",
      "cognix_enterprise_chat",
      "cognix_favorite_models",
      "cognix_realtime_collaboration",
      "cognix_skill_marketplace",
      "cognix_project_skills_directives",
      '"/chat/enterprise/blueprint"',
      '"/chat/enterprise/chats"',
      '"/chat/enterprise/chats/{chat_id}"',
      '"/chat/enterprise/chats/{chat_id}/messages"',
      '"/chat/enterprise/chats/{chat_id}/key-rotation-plan"',
      "enterprise_chat_creation_planned",
      "enterprise_encrypted_message_planned",
      "enterprise_chat_key_rotation_planned",
      '"/skills/marketplace/blueprint"',
      '"/skills/marketplace"',
      '"/skills/marketplace/skills"',
      '"/skills/marketplace/skills/{skill_id}/approval"',
      '"/skills/marketplace/usage"',
      '"/projects/{project_id}/skills/blueprint"',
      '"/projects/{project_id}/skills"',
      '"/projects/{project_id}/skills/injection-plan"',
      '"/projects/{project_id}/directives/blueprint"',
      '"/projects/{project_id}/directives"',
      '"/projects/{project_id}/directives/compile"',
      '"/projects/{project_id}/realtime/blueprint"',
      '"/projects/{project_id}/realtime/presence"',
      '"/projects/{project_id}/comments"',
      '"/projects/{project_id}/comments/{comment_id}/resolve"',
      '"/projects/{project_id}/collaboration/events"',
      '"/projects/{project_id}/collaboration/conflict-plan"',
      '"/models/favorites/blueprint"',
      '"/models/favorites"',
      '"/models/favorites/{model_id:path}"',
      '"/models/default"',
      '"/models/quick-switcher"',
      '"/agent-mode/blueprint"',
      '"/agent-mode/sessions"',
      '"/agent-mode/sessions/{session_id}"',
      '"/agent-mode/sessions/{session_id}/steps/{step_id}"',
      '"/agent-mode/sessions/{session_id}/tool-call-plan"',
      '"/agent-mode/sessions/{session_id}/outputs"',
      '"/cowork/blueprint"',
      '"/cowork/sessions"',
      '"/cowork/sessions/{session_id}"',
      '"/cowork/sessions/{session_id}/status"',
      '"/cowork/sessions/{session_id}/actions"',
      "agent_mode_session_planned",
      "agent_mode_step_updated",
      "agent_mode_tool_call_planned",
      "agent_mode_output_created",
      "cowork_session_planned",
      "cowork_status_updated",
      "cowork_action_planned",
      ...
      "project_collaboration_event_planned",
      "project_conflict_resolution_planned",
      "favorite_model_upserted",
      "user_default_model_set",
      "project_default_model_set",
  ...
  {
    file: "src/features/hub/internal-skills-marketplace.tsx",
    includes: [
  ...
  {
    file: "src/features/hub/hub-page.tsx",
    includes: [
      "InternalSkillsMarketplace",
  ...
  {
    file: "../backend/tests/test_cognix_skill_marketplace.py",
    includes: [
      "test_skill_marketplace_blueprint_declares_services_and_tables",
      "test_skill_marketplace_publish_approve_and_usage_flow",
      "test_skill_marketplace_blocks_non_admin_approval_and_unapproved_usage",
      '"/api/cognix/skills/marketplace/skills"',
      '"/api/cognix/skills/marketplace/usage"',
      '"shared_skills"',
      '"skill_approvals"',
  ...
  {
    file: "../backend/tests/test_cognix_enterprise_chat.py",
    includes: [
      "test_enterprise_chat_blueprint_declares_e2ee_and_compliance_modes",
      "test_enterprise_e2ee_chat_stores_metadata_and_encrypted_messages_only",
      "test_enterprise_chat_blocks_non_members_and_missing_encrypted_payload",
      '"/api/cognix/chat/enterprise/chats"',
      '"/api/cognix/chat/enterprise/chats/{chat_id}"',
      '"enterprise_chats"',
      '"encrypted_messages"',
      "serverStoresKeyMaterial",
      "plaintextStored",
    ],
  },
  {
    file: "../backend/tests/test_cognix_agent_mode.py",
    includes: [
      "test_agent_mode_blueprint_declares_native_services_and_safety",
      "test_agent_mode_session_tracks_steps_tool_plans_and_outputs",
      "test_agent_mode_blocks_non_owner_project_and_legacy_agent_run_uses_native_session",
      '"/api/cognix/agent-mode/sessions"',
      ...
      '"agent_tool_calls"',
      '"agent_outputs"',
      "directToolExecutionAllowed",
      "willExecuteNow",
    ],
  },
  {
    file: "../backend/tests/test_cognix_cowork.py",
    includes: [
      "test_cowork_blueprint_declares_native_services_and_no_execution",
      "test_cowork_session_actions_status_and_user_scope",
      "test_cowork_blocks_non_owner_project_and_audits_actions",
      '"/api/cognix/cowork/sessions"',
      '"cowork_sessions"',
      '"cowork_actions"',
      '"cowork_permissions"',
  ...
  {
    file: "../backend/tests/test_cognix_realtime_collaboration.py",
    includes: [
      "test_realtime_collaboration_blueprint_declares_native_services_and_safety",
      "test_realtime_presence_comments_and_events_work_for_project_collaborators",
      "test_realtime_collaboration_blocks_non_members_and_requires_edit_for_conflicts",
  ...
  {
    file: "../backend/tests/test_cognix_project_skills_directives.py",
    includes: [
      "test_project_skill_and_directive_blueprints_declare_native_services",
      "test_project_skill_directive_tables_have_native_columns",
      "test_project_skill_filters_tools_to_existing_permissions_and_builds_injection_plan",
      "test_project_directives_compile_with_security_priority",
  ...
  {
    file: "../backend/core/cognix/admin_project_oversight.py",
    includes: [
      ...
      "build_admin_project_oversight",
      "build_project_action_plan",
      "build_project_admin_report",
  ...
  },
  {
    ...
    includes: [
      ...
      "def _ensure_admin_project_oversight_columns",
      "admin_project_events",
      "project_admin_reports",
  ...
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_admin_project_oversight",
      "AdminProjectActionPlanRequest",
      "AdminProjectReportRequest",
      '"/admin/projects/blueprint"',
      '"/admin/projects"',
      '"/admin/projects/{project_id}"',
      '"/admin/projects/{project_id}/action-plan"',
      '"/admin/projects/{project_id}/report"',
      "admin_project_action_planned",
      "admin_project_report_generated",
    ],
  },
  {
    file: "../backend/core/cognix/module_registry.py",
    includes: [
      '"cognix-admin-project-oversight"',
  ...
  {
    file: "../backend/tests/test_cognix_admin_project_oversight.py",
    includes: [
      "test_admin_project_oversight_blueprint_schema_and_surface_contract",
      "test_admin_project_oversight_routes_plan_action_and_persist_report",
      "cognix_admin_project_service_v1",
      "admin_project_events",
      "project_admin_reports",
      '"/api/cognix/admin/projects"',
    ],
  ...
  {
    file: "../backend/core/cognix/admin_organization_settings.py",
    includes: [
      ...
      "build_organization_settings_blueprint",
      "build_policy_enforcement_plan",
      "policy_records_from_settings",
  ...
  },
  {
    ...
    includes: [
      ...
      "def _ensure_admin_organization_settings_columns",
  ...
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_admin_organization_settings",
      "AdminOrganizationSettingsRequest",
      "AdminPolicyEnforcementRequest",
      '"/admin/settings/blueprint"',
      '"/admin/settings"',
      '"/admin/settings/enforcement-plan"',
      '"/admin/settings/change-logs"',
      "admin_organization_settings_updated",
      "cognix_db.list_organization_policies()",
    ],
  },
  {
    file: "../backend/core/cognix/admin_permissions.py",
    includes: [
      "role_permissions + user_overrides + project_permissions + legacy_user_permissions + list(organization_policy or [])",
  ...
  {
    file: "../backend/tests/test_cognix_admin_organization_settings.py",
    includes: [
      "test_admin_organization_settings_blueprint_schema_and_surface_contract",
      "test_admin_organization_settings_routes_update_policy_enforce_and_feed_permissions",
      "cognix_organization_policy_service_v1",
      "cloud_disabled_by_organization_policy",
      "organization_policy",
      '"/api/cognix/admin/settings"',
    ],
  },
  {
    file: "../backend/core/cognix/admin_compliance_export.py",
    includes: [
      ...
      "ReportBuilder",
      "ExportJobService",
      "build_compliance_export_blueprint",
      "build_compliance_report",
      "build_export_job_plan",
      '"compliance_exports"',
      '"export_jobs"',
  ...
  },
  {
    ...
    includes: [
      ...
      "def _ensure_admin_compliance_export_columns",
  ...
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_admin_compliance_export",
      "AdminComplianceExportRequest",
      '"/admin/compliance/exports/blueprint"',
      '"/admin/compliance/exports"',
      '"/admin/compliance/exports/plan"',
      '"/admin/compliance/exports/{export_id}"',
      "admin_compliance_export_created",
  ...
  },
  {
    file: "../backend/core/cognix/module_registry.py",
    includes: [
      '"cognix-admin-compliance-export"',
  ...
  {
    file: "../backend/tests/test_cognix_admin_compliance_export.py",
    includes: [
      "test_compliance_export_blueprint_schema_and_module_registry",
      "test_compliance_export_routes_plan_create_and_fetch_report",
      "cognix_compliance_export_service_v1",
  ...
  {
    file: "../backend/tests/test_cognix_notifications_alerts.py",
    includes: [
      "test_notifications_blueprint_schema_registry_and_surface_contract",
      "test_approval_notifications_alerts_preferences_and_read_state",
      "cognix_notification_service_v1",
      "notification_preferences",
      "admin_alerts",
      "approval_requested",
      "approval_approved",
  ...
  {
    file: "../backend/tests/test_cognix_admin_sensitive_audit.py",
    includes: [
      "test_sensitive_audit_blueprint_schema_registry_and_surface_contract",
      "test_sensitive_actions_auto_persist_append_only_logs",
      "cognix_sensitive_audit_v1",
      "sensitive_action_logs",
      "admin_chat_read",
      "codex_code_modification",
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      "def _ensure_admin_local_only_columns",
      "def upsert_local_only_policy",
      "def get_local_only_policy",
      "def list_local_only_policies",
      "def create_blocked_external_call",
      "def list_blocked_external_calls",
    ],
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_admin_local_only",
      "AdminLocalOnlyPolicyRequest",
      "AdminLocalOnlyDecisionRequest",
      '"/admin/local-only/blueprint"',
      '"/admin/local-only"',
      '"/admin/local-only/policy"',
      '"/admin/local-only/enforcement-plan"',
      '"/admin/local-only/egress-decision"',
      '"/admin/local-only/blocked-calls"',
      "admin_local_only_policy_updated",
      "admin_local_only_external_call_blocked",
      "create_blocked_external_call",
    ],
  },
  {
    file: "../backend/core/cognix/module_registry.py",
  ...
  {
    file: "../backend/tests/test_cognix_admin_local_only.py",
    includes: [
      "test_local_only_blueprint_schema_module_registry_and_surface_contract",
      "test_local_only_routes_policy_settings_blocking_and_allowed_localhost",
      "cognix_local_only_policy_engine_v1",
      "cloud_provider_blocked_by_local_only_policy",
      "admin_local_only_external_call_blocked",
    ],
  },
  {
    file: "../backend/core/cognix/admin_secure_model_registry.py",
    includes: [
      ...
      "build_secure_model_registry_blueprint",
      "build_model_security_metadata",
      "build_model_access_decision",
      "checksumVerified",
    ],
  },
  {
    ...
    includes: [
      ...
      "def _ensure_admin_secure_model_registry_columns",
      "def approve_model",
      "def list_approved_models",
      "def block_model",
      "def list_blocked_models",
      "def upsert_model_security_metadata",
      "def list_model_security_metadata",
    ],
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_admin_secure_model_registry",
      "AdminSecureModelApprovalRequest",
      "AdminSecureModelBlockRequest",
      "AdminSecureModelDecisionRequest",
      '"/admin/models/secure-registry/blueprint"',
      '"/admin/models/secure-registry"',
      '"/admin/models/secure-registry/approve"',
      '"/admin/models/secure-registry/block"',
      '"/admin/models/secure-registry/access-decision"',
      "admin_secure_model_approved",
      "admin_secure_model_blocked",
      "allowedModels",
    ],
  },
  {
    file: "../backend/core/cognix/module_registry.py",
    includes: [
      '"cognix-enterprise-secure-model-registry"',
  ...
  {
    file: "../backend/tests/test_cognix_admin_secure_model_registry.py",
    includes: [
      "test_secure_model_registry_blueprint_schema_module_registry_and_surface_contract",
      "test_secure_model_registry_routes_approve_block_and_decide_access",
      "cognix_secure_model_registry_v1",
      "role_not_allowed_for_model",
      "admin_secure_model_blocked",
    ],
  },
  {
    file: "../backend/core/cognix/shared_knowledge_base.py",
    includes: [
      ...
      "build_shared_knowledge_blueprint",
      "chunk_document_text",
      "filter_chunks_for_user",
      "build_retrieval_result",
      "permissionFilteredRetrieval",
    ],
  },
  {
    file: "../backend/storage/cognix_db.py",
    includes: [
      ...
      "def _ensure_shared_knowledge_columns",
  ...
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_shared_knowledge_base",
      "SharedKnowledgeBaseRequest",
      "SharedKnowledgeDocumentRequest",
      "SharedKnowledgePermissionRequest",
      "SharedKnowledgeQueryRequest",
      '"/knowledge/shared/blueprint"',
      '"/knowledge/shared/bases"',
      '"/knowledge/shared/bases/{knowledge_base_id}/documents"',
      '"/knowledge/shared/bases/{knowledge_base_id}/permissions"',
      '"/knowledge/shared/bases/{knowledge_base_id}/query"',
      "shared_knowledge_document_indexed",
      "shared_knowledge_permission_granted",
    ],
  },
  {
    file: "../backend/core/cognix/module_registry.py",
  ...
  {
    file: "../backend/tests/test_cognix_shared_knowledge_base.py",
    includes: [
      "test_shared_knowledge_blueprint_schema_module_registry_and_surface_contract",
      "test_shared_knowledge_routes_index_permissions_and_filtered_retrieval",
      "cognix_shared_knowledge_base_v1",
      "permissionFilteredRetrieval",
      "shared_knowledge_permission_granted",
    ],
  },
  {
    file: "../backend/core/cognix/admin_data_retention.py",
    includes: [
      ...
      '"deletion_jobs"',
      '"privacy_events"',
      "build_data_retention_blueprint",
      "build_privacy_decision",
      "build_retention_plan",
      "build_user_export_plan",
  ...
  },
  {
    ...
    includes: [
      ...
      "def _ensure_admin_data_retention_columns",
  ...
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_admin_data_retention",
      "AdminDataRetentionPolicyRequest",
      "AdminPrivacyDecisionRequest",
      "AdminUserDataRequest",
      '"/admin/data-retention/blueprint"',
      '"/admin/data-retention"',
      '"/admin/data-retention/policy"',
      '"/admin/data-retention/plan"',
      '"/admin/data-retention/privacy-decision"',
      '"/admin/data-retention/users/{username}/export-plan"',
      '"/admin/data-retention/users/{username}/deletion-plan"',
      "admin_data_retention_policy_updated",
      "admin_privacy_decision_logged",
      "admin_user_export_planned",
      "admin_user_deletion_planned",
    ],
  },
  {
    file: "../backend/core/cognix/module_registry.py",
  ...
  {
    file: "../backend/tests/test_cognix_admin_data_retention.py",
    includes: [
      "test_data_retention_blueprint_schema_module_registry_and_surface_contract",
      "test_data_retention_routes_policy_privacy_export_and_deletion_jobs",
      "cognix_data_retention_service_v1",
      "retention_policy_updated",
      "admin_user_deletion_planned",
    ],
  },
  {
    file: "../backend/core/cognix/education_spaces.py",
    includes: [
      ...
      "build_education_blueprint",
      "build_space_plan",
      "build_class_plan",
      "build_course_plan",
      "build_assignment_plan",
      "build_exam_policy_plan",
      "build_exam_access_decision",
  ...
  },
  {
    ...
    includes: [
      ...
      "def _ensure_education_space_columns",
      "def create_education_space",
      "def list_education_spaces",
      "def create_education_class",
      "def add_education_member",
      "def create_education_course",
      "def create_education_assignment",
      "def upsert_education_exam_policy",
      "def get_education_exam_policy",
      '"education_exam_policies"',
    ],
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_education_spaces",
      "EducationSpaceRequest",
      "EducationClassRequest",
      "EducationAssignmentRequest",
      "EducationExamPolicyRequest",
      '"/education/blueprint"',
      '"/education/spaces"',
      '"/education/spaces/{space_id}/classes"',
      '"/education/classes/{class_id}/members"',
      '"/education/classes/{class_id}/courses"',
      '"/education/classes/{class_id}/assignments"',
      '"/education/assignments/{assignment_id}/exam-policy"',
      '"/education/assignments/{assignment_id}/exam-access-decision"',
  ...
  {
    file: "../backend/tests/test_cognix_education_spaces.py",
    includes: [
      "test_education_spaces_blueprint_schema_module_registry_and_surface_contract",
      "test_education_routes_create_class_assignment_and_guard_exam_tools",
      "cognix_education_space_service_v1",
      "tool_not_allowed_by_exam_policy",
      "education_exam_policy_updated",
    ],
  },
  {
    file: "../backend/core/cognix/edition_billing.py",
    includes: [
      ...
      "build_edition_billing_blueprint",
      "build_plan_catalog",
      "build_entitlement_decision",
      "build_billing_event_plan",
      "build_workspace_provisioning_plan",
  ...
  },
  {
    ...
    includes: [
      ...
      "def _ensure_edition_billing_columns",
      ...
      "def create_workspace_from_plan",
  ...
  },
  {
    file: "../backend/routes/cognix.py",
    includes: [
      "cognix_edition_billing",
      "EntitlementDecisionRequest",
      "BillingEventPlanRequest",
      "WorkspaceProvisioningPlanRequest",
      '"/editions/blueprint"',
      '"/editions/plans"',
      '"/editions/entitlements/decision"',
      '"/admin/workspaces/provision-plan"',
      '"/admin/workspaces"',
      '"/admin/billing/events/plan"',
      '"/admin/billing/events"',
      "workspace_provisioning_planned",
      "billing_event_planned",
      "paymentProcessorCall",
    ],
  },
  {
    file: "../backend/core/cognix/module_registry.py",
    includes: [
      '"cognix-edition-billing-policy"',
  ...
  {
    file: "../backend/tests/test_cognix_edition_billing.py",
    includes: [
      "test_edition_billing_blueprint_schema_registry_and_surface_contract",
      "test_edition_routes_sync_entitlements_workspace_and_billing_guardrails",
      "cognix_plan_catalog_v1",
      "module_not_in_plan",
      "planned_no_payment_mutation",
      "billing_event_planned",
    ],
  },
  {
