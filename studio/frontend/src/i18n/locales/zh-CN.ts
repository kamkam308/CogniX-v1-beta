  ...
  settings: {
    ...
    general: {
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "这会清除仅保存在本地的偏好设置，然后重新加载 CogniX。聊天、API 访问权限和数据库中的设置不会受到影响。",
        confirmAction: "重置并重新加载",
      },
    },
    profile: {
      title: "个人资料",
      description: "更新你在 CogniX 中显示的个人资料。",
      changePicture: "更换头像",
      displayName: "显示名称",
      nickname: "CogniX 应该怎么称呼你？",
    ...
    appearance: {
      title: "外观",
      description: "调整 CogniX 在此设备上的显示方式。",
      language: {
        title: "语言",
        label: "显示语言",
        description: "选择 CogniX 使用的语言。",
      },
      theme: {
        title: "主题",
        label: "颜色主题",
    ...
    apiKeys: {
      title: "API",
      description: "通过兼容 OpenAI 的 API 以编程方式访问 CogniX。",
      readDocs: "阅读 API 文档",
      ...
      secureHttpsHint:
        "0.0.0.0 端口仍可被全网访问。如需完全安全，请使用 --secure 启动 CogniX，仅暴露此 HTTPS 链接。",
    ...
    about: {
      title: "关于",
      description: "文档、发布说明、反馈和 CogniX 构建信息。",
      studioVersion: "CogniX 版本",
      packageVersion: "包版本",
      ...
      dangerZone: "危险区域",
      shutDownStudio: "关闭 CogniX",
      shutDownStudioDescription: "停止 CogniX 服务进程并结束你的会话。",
      shutDown: "关闭",
      update: {
        title: "更新 CogniX",
        ...
        checkingInstall: "正在检查 CogniX 的安装方式...",
        installIntro: "安装或更新 CogniX：",
        ...
        unknownInstall:
          "CogniX 无法检测安装方式。如果你使用一键安装器或 PyPI 安装，请使用上面的命令。",
        localCheckout:
