  ...
  return (
    ...
    >
      <SidebarHeader className="pl-[17px] pr-3 pt-[14px] pb-[8px] group-data-[collapsible=icon]:px-0">
        ...
        {/* Collapsed: the CogniX mark doubles as the expand trigger */}
        {!isMobile && (
            ...
            <Tooltip>
              <TooltipPrimitive.Trigger asChild>
                <button
                  type="button"
                  onClick={togglePinned}
                  className="inline-flex h-[33px] w-[33px] cursor-pointer items-center justify-center rounded-full transition-colors hover:bg-nav-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
