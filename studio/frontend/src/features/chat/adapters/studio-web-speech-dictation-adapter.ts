...
const describeMediaError = (error: unknown): string => {
  ...
  if (error.name === "NotAllowedError") {
    return "Microphone access is blocked. Allow microphone access for this CogniX page, then try again.";
  }
...
const describeSpeechError = (error: string, message?: string): string => {
  if (error === "not-allowed") {
    return "Speech recognition was blocked by the browser. Check microphone permissions for this CogniX page.";
  }
