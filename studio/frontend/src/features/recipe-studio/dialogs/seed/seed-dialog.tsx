    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-1.5">
        ...
        <p id={tokenHelpId} className="text-xs text-muted-foreground">
          {usingEnvToken
            ? "CogniX detected a server env token, so saved/shared recipes can leave this blank."
            : "Blank is safest for saved/shared recipes because CogniX will read the server environment at run time."}
        </p>
        {hasToken && (
