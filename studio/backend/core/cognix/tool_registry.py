...
RATE_LIMIT_POLICIES: dict[str, dict[str, int]] = {
    ...
    "latex:render": {"windowSeconds": 60, "maxEvents": 240},
...
TOOL_MANIFESTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "category": "rendering",
        "description": "Preparation native de paquets de rendu LaTeX/KaTeX sans compilation serveur.",
        "connector": "local-latex-renderer",
        "enabled": True,
        "dataIsolation": "none",
        "actions": [
            {
                "id": "render_math",
                "label": "Rendre une formule",
                "description": "Valider une expression LaTeX bornee et produire un paquet Markdown KaTeX.",
                "mode": "execute",
                "permissions": [IMPLICIT_AUTHENTICATED_PERMISSION],
                "riskLevel": "low",
                "requiresConfirmation": False,
