...
MODULE_MANIFESTS: list[dict[str, Any]] = [
    ...
    {
        "id": "cognix-favorite-models",
        "displayName": "CogniX Favorite Models",
        "editionTargets": ["free", "local", "developer", "business", "university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            "pin_model",
        ...
        "routes": [
            "/api/cognix/models/favorites/blueprint",
            "/api/cognix/models/favorites",
            "/api/cognix/models/favorites/{model_id}",
            "/api/cognix/models/default",
            "/api/cognix/models/quick-switcher",
            "/api/cognix/model-pins",
            "/api/cognix/project-model-defaults",
            "/api/cognix/projects/{project_id}/default-model",
        ],
        "permissions": ["authenticated"],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["model-selector", "model-hub", "chat-quick-switcher", "project-settings"],
        "dependencies": ["cognix-local-core", "cognix-model-lifecycle", "cognix-projects"],
    },
    {
    ...
    },
    {
        ...
        "capabilities": [
            ...
            "prompt_cache_planning",
            "prompt_cache_runtime_contract",
            "stable_prefix_cache_policy",
        ...
        "routes": [
            ...
            "/api/cognix/optimizations/prompt-cache-plan",
    ...
    },
    {
        ...
        "capabilities": [
            ...
            "conversation_summary_contract",
            "secret_redacted_summary",
    ...
    },
    {
        ...
        "routes": [
            ...
            "/api/cognix/notifications/blueprint",
            "/api/cognix/notifications",
            "/api/cognix/notifications/{notification_id}/read",
            "/api/cognix/notifications/preferences",
            "/api/cognix/notifications/preferences/{notification_type}",
        ],
        "permissions": ["authenticated"],
        "tools": [],
        "defaultModels": [],
    ...
    },
    {
        ...
        "routes": [
            ...
            "/api/cognix/agent-mode/sessions/{session_id}",
            "/api/cognix/agent-mode/sessions/{session_id}/steps/{step_id}",
            "/api/cognix/agent-mode/sessions/{session_id}/tool-call-plan",
            "/api/cognix/agent-mode/sessions/{session_id}/outputs",
            "/api/cognix/agent-runs",
        ],
        "permissions": ["authenticated", "sensitive_tools_require_confirmation"],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["chat", "developer-workflow", "activity-center"],
        "dependencies": [
            "cognix-local-core",
    ...
    },
    {
        ...
        "capabilities": [
            ...
            "human_approval_gate",
            "pause_stop_controls",
            "project_boundary_enforcement",
            "never_stealth_policy",
        ],
        "routes": [
        ...
        "permissions": ["authenticated", "cowork:control", "human_approval_for_high_risk_actions"],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["cowork", "command-palette", "developer-workflow"],
        "dependencies": [
            "cognix-local-core",
    ...
    },
    {
        ...
        "capabilities": [
            ...
            "websocket_ready_contract",
            "rest_realtime_fallback",
        ],
        "routes": [
        ...
        "permissions": ["authenticated", "project_member", "project_comment", "project_edit_for_conflicts"],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["project-collaboration", "project-comments", "presence-rail"],
        "dependencies": ["cognix-local-core", "cognix-projects"],
    },
    {
    ...
    {
        "id": "cognix-shared-knowledge-base",
        "displayName": "CogniX Shared Knowledge Base",
        "editionTargets": ["business", "university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            "shared_knowledge_base_service",
            "organization_rag_service",
            "document_permission_filter",
            "knowledge_base_documents",
            "native_chunking",
            "permission_filtered_retrieval",
            "source_visibility",
            "document_comments_ready",
            "deny_by_default_chunks",
        ],
        "routes": [
            "/api/cognix/knowledge/shared/blueprint",
            "/api/cognix/knowledge/shared/bases",
            "/api/cognix/knowledge/shared/bases/{knowledge_base_id}/documents",
            "/api/cognix/knowledge/shared/bases/{knowledge_base_id}/permissions",
            "/api/cognix/knowledge/shared/bases/{knowledge_base_id}/query",
        ],
        "permissions": [
            "authenticated",
            "knowledge:read",
        ...
        "tools": [],
        "defaultModels": ["cognix-general-small"],
        "uiPanels": ["library", "project-documents", "organization-knowledge"],
        "dependencies": ["cognix-local-core", "cognix-rag", "cognix-admin-organization-settings"],
    },
    {
    ...
    },
    {
        ...
        "capabilities": [
            ...
            "connector_secret_rotation_contract",
            "server_side_secret_rotation",
        ...
        "routes": [
            ...
            "/api/cognix/integrations/secret-rotation-contract",
    ...
    },
    {
        ...
        "capabilities": [
            ...
            "role_limited_skills",
            "skill_usage_logs",
            "internal_skill_disable",
        ],
        "routes": [
            "/api/cognix/skills/marketplace/blueprint",
            "/api/cognix/skills/marketplace",
            "/api/cognix/skills/marketplace/skills",
            "/api/cognix/skills/marketplace/skills/{skill_id}/approval",
            "/api/cognix/skills/marketplace/usage",
        ],
        "permissions": ["authenticated", "admin_for_approval"],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["marketplace", "hub", "project-skills"],
        "dependencies": ["cognix-local-core", "cognix-long-term-skill-memory", "cognix-admin-operations"],
    },
    {
        ...
        "capabilities": [
            ...
            "skill_permission_binder",
            "project_directives",
            "model_directives",
            "prompt_policy_compiler",
            "directive_conflict_resolution",
        ],
        "routes": [
            "/api/cognix/projects/{project_id}/skills/blueprint",
            "/api/cognix/projects/{project_id}/skills",
            "/api/cognix/projects/{project_id}/skills/injection-plan",
            "/api/cognix/projects/{project_id}/directives/blueprint",
            "/api/cognix/projects/{project_id}/directives",
            "/api/cognix/projects/{project_id}/directives/compile",
        ],
        "permissions": ["authenticated", "project_owner", "tool_permission_binding_without_escalation"],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["project-settings", "project-skills", "project-directives", "chat-context"],
        "dependencies": ["cognix-local-core", "cognix-projects", "cognix-tool-discovery"],
    },
    {
        ...
        "capabilities": [
            ...
            "true_e2ee_chat",
            "message_encryption_metadata",
            "client_side_key_policy",
            "key_rotation_plan",
            "member_revocation_policy",
            "metadata_only_admin_visibility",
        ],
        "routes": [
            "/api/cognix/chat/enterprise/blueprint",
            "/api/cognix/chat/enterprise/chats",
            "/api/cognix/chat/enterprise/chats/{chat_id}",
            "/api/cognix/chat/enterprise/chats/{chat_id}/messages",
            "/api/cognix/chat/enterprise/chats/{chat_id}/key-rotation-plan",
        ],
        "permissions": ["authenticated", "organization_member", "project_owner_when_project_scoped"],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["chat-enterprise", "project-collaboration", "compliance-center"],
        "dependencies": ["cognix-local-core", "cognix-enterprise-foundation", "cognix-admin-chat-access"],
    },
    {
    ...
    {
        "id": "cognix-edition-billing-policy",
        "displayName": "CogniX Edition & Billing Policy",
        "editionTargets": ["free", "local", "developer", "business", "university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            "plan_catalog_service",
            "entitlement_policy_engine",
            "billing_event_ledger",
            "workspace_provisioning_planner",
            "billing_approval_gate",
            "server_side_entitlements",
            "payment_processor_call_block",
            "billing_mutation_approval_required",
        ],
        "routes": [
            "/api/cognix/editions/blueprint",
            "/api/cognix/editions/plans",
            "/api/cognix/editions/entitlements/decision",
            "/api/cognix/admin/workspaces/provision-plan",
        ...
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["admin-dashboard", "organization-settings", "billing-settings"],
        "dependencies": ["cognix-local-core", "cognix-admin-operations", "cognix-admin-organization-settings"],
    },
    {
        "id": "cognix-education-spaces",
        "displayName": "CogniX Education Spaces",
        "editionTargets": ["university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            "education_space_service",
            "classroom_manager",
            "course_planner",
            "assessment_policy_engine",
            "exam_guard",
            "teacher_student_roles",
            "class_permissions",
            "course_outline_planning",
            "assignment_exam_policy",
            "anti_abuse_exam_mode",
        ],
        "routes": [
            "/api/cognix/education/blueprint",
            "/api/cognix/education/spaces",
            "/api/cognix/education/spaces/{space_id}/classes",
            "/api/cognix/education/classes/{class_id}/members",
            "/api/cognix/education/classes/{class_id}/courses",
            "/api/cognix/education/classes/{class_id}/assignments",
            "/api/cognix/education/assignments/{assignment_id}/exam-policy",
        ...
        "tools": [],
        "defaultModels": ["cognix-general-small"],
        "uiPanels": ["education-admin", "project-documents", "admin-dashboard"],
        "dependencies": ["cognix-local-core", "cognix-enterprise-foundation", "cognix-shared-knowledge-base"],
    },
    {
        ...
        "capabilities": [
            ...
            "audit_log_service",
            "sensitive_action_logger",
            "audit_search_service",
            "sensitive_action_logs",
            "admin_alert_service",
            "admin_alerts",
            "approval_alert_notifications",
        ...
        "routes": [
            ...
            "/api/cognix/admin/sensitive-audit/blueprint",
            "/api/cognix/admin/sensitive-action-logs",
            "/api/cognix/admin/notifications/blueprint",
            "/api/cognix/admin/alerts",
            "/api/cognix/admin/alerts/{alert_id}/acknowledge",
    ...
    {
        "id": "cognix-admin-project-oversight",
        "displayName": "CogniX Admin Project Oversight",
        "editionTargets": ["business", "university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            "admin_project_service",
            "project_inventory",
            "project_owner_visibility",
            "project_member_visibility",
            "project_model_usage_visibility",
            "project_token_usage_visibility",
            "project_cost_visibility",
            "project_permission_visibility",
            "project_risk_analyzer",
            "project_usage_aggregator",
            "project_action_planning",
            "project_admin_reports",
            "project_admin_event_audit",
        ],
        "routes": [
            "/api/cognix/admin/projects/blueprint",
            "/api/cognix/admin/projects",
            "/api/cognix/admin/projects/{project_id}",
            "/api/cognix/admin/projects/{project_id}/action-plan",
            "/api/cognix/admin/projects/{project_id}/report",
        ],
        "permissions": [
            "admin",
            "admin:projects:read",
            "admin:projects:archive",
            "admin:projects:transfer",
            "admin:projects:members",
            "admin:projects:models",
            "admin:projects:cloud",
            "admin:projects:export",
        ],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["admin-dashboard", "admin-projects", "project-settings"],
        "dependencies": ["cognix-enterprise-foundation", "cognix-admin-operations"],
    },
    {
        "id": "cognix-admin-organization-settings",
        "displayName": "CogniX Admin Organization Settings",
        "editionTargets": ["business", "university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            "organization_policy_service",
            "policy_enforcer",
            "admin_settings_service",
            "cloud_policy",
            "external_model_policy",
            "e2ee_policy",
            "admin_chat_access_policy",
            "data_retention_policy",
            "role_quota_policy",
            "allowed_model_policy",
            "allowed_app_policy",
            "default_permission_policy",
            "approval_requirement_policy",
            "policy_change_logs",
            "permission_engine_policy_integration",
        ],
        "routes": [
            "/api/cognix/admin/settings/blueprint",
            "/api/cognix/admin/settings",
            "/api/cognix/admin/settings/enforcement-plan",
            "/api/cognix/admin/settings/change-logs",
        ],
        "permissions": [
            "admin",
            "admin:settings:read",
            "admin:settings:update",
            "admin:policies:enforce",
        ],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["admin-dashboard", "organization-settings", "admin-permissions"],
        "dependencies": ["cognix-enterprise-foundation", "cognix-admin-operations"],
    },
    {
        "id": "cognix-enterprise-local-only-mode",
        "displayName": "CogniX Enterprise Local-Only Mode",
        "editionTargets": ["business", "university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            "local_only_policy_engine",
            ...
            "internal_logs_only",
            "local_only_badge",
            "blocked_external_call_audit",
        ],
        "routes": [
            "/api/cognix/admin/local-only/blueprint",
            "/api/cognix/admin/local-only",
            "/api/cognix/admin/local-only/policy",
            "/api/cognix/admin/local-only/enforcement-plan",
            "/api/cognix/admin/local-only/egress-decision",
            "/api/cognix/admin/local-only/blocked-calls",
        ],
        "permissions": [
            "admin",
            "admin:local-only:read",
            "admin:local-only:update",
            "admin:local-only:enforce",
        ],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["admin-dashboard", "organization-settings", "admin-security"],
        "dependencies": ["cognix-enterprise-foundation", "cognix-admin-organization-settings"],
    },
    {
        "id": "cognix-enterprise-secure-model-registry",
        "displayName": "CogniX Enterprise Secure Model Registry",
        "editionTargets": ["business", "university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            "secure_model_registry",
            "model_approval_service",
            "model_license_checker",
            "model_checksum_verifier",
            "approved_model_control",
            "blocked_model_control",
            "role_limited_models",
            "quantization_requirement",
            "local_only_requirement",
            "license_visibility",
            "source_visibility",
            "checksum_visibility",
            "allowed_models_policy_sync",
        ],
        "routes": [
            "/api/cognix/admin/models/secure-registry/blueprint",
            "/api/cognix/admin/models/secure-registry",
            "/api/cognix/admin/models/secure-registry/approve",
            "/api/cognix/admin/models/secure-registry/block",
            "/api/cognix/admin/models/secure-registry/access-decision",
            "/api/cognix/admin/models/secure-registry/security-metadata",
        ],
        "permissions": [
            "admin",
            "admin:models:registry:read",
            "admin:models:registry:update",
            "admin:models:registry:decide",
        ],
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["admin-dashboard", "organization-settings", "admin-models"],
        "dependencies": [
            "cognix-enterprise-foundation",
            "cognix-admin-organization-settings",
            "cognix-enterprise-local-only-mode",
        ],
    },
    {
        "id": "cognix-admin-data-retention-privacy",
        "displayName": "CogniX Admin Data Retention & Privacy",
        "editionTargets": ["business", "university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            ...
            "user_deletion_jobs",
            "privacy_event_audit",
            "e2ee_strict_content_boundary",
        ],
        "routes": [
            "/api/cognix/admin/data-retention/blueprint",
            "/api/cognix/admin/data-retention",
            "/api/cognix/admin/data-retention/policy",
            "/api/cognix/admin/data-retention/plan",
            "/api/cognix/admin/data-retention/privacy-decision",
            "/api/cognix/admin/data-retention/users/{username}/export-plan",
            "/api/cognix/admin/data-retention/users/{username}/deletion-plan",
            "/api/cognix/admin/data-retention/deletion-jobs",
            "/api/cognix/admin/data-retention/privacy-events",
        ],
        "permissions": [
            "admin",
            "admin:data-retention:read",
        ...
        "defaultModels": [],
        "uiPanels": ["admin-dashboard", "organization-settings", "admin-security"],
        "dependencies": ["cognix-enterprise-foundation", "cognix-admin-operations", "cognix-admin-organization-settings"],
    },
    {
        "id": "cognix-admin-compliance-export",
        "displayName": "CogniX Admin Compliance Export",
        "editionTargets": ["business", "university", "enterprise"],
        "status": "enabled",
        "capabilities": [
            ...
            "export_job_service",
            "token_usage_exports",
            "user_activity_exports",
            "security_threat_exports",
            "banned_user_exports",
            "approval_exports",
            "model_usage_exports",
            "tool_usage_exports",
            "document_access_exports",
            "admin_chat_access_exports",
            "json_markdown_csv_pdf_contract",
            "export_checksum",
        ],
        "routes": [
            "/api/cognix/admin/compliance/exports/blueprint",
            "/api/cognix/admin/compliance/exports",
            "/api/cognix/admin/compliance/exports/plan",
            "/api/cognix/admin/compliance/exports/{export_id}",
        ],
        "permissions": [
            "admin",
        ...
        "tools": [],
        "defaultModels": [],
        "uiPanels": ["admin-dashboard", "admin-security", "compliance-center"],
        "dependencies": ["cognix-enterprise-foundation", "cognix-admin-operations", "cognix-admin-chat-access"],
    },
    {
        ...
        "routes": [
            ...
            "/api/cognix/admin/system-health/blueprint",
            "/api/cognix/admin/system-health",
            "/api/cognix/admin/system-health/snapshot",
            "/api/cognix/admin/system-health/snapshots",
            "/api/cognix/admin/system-health/service-events",
            "/api/cognix/admin/audit-logs",
            "/api/cognix/admin/sensitive-audit/blueprint",
            "/api/cognix/admin/sensitive-action-logs",
        ],
