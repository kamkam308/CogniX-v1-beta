...
@router.get("/hardware")
async def get_hardware_utilization(current_subject: str = Depends(get_current_jwt_subject)):
    """
...
async def start_training(
    request: TrainingStartRequest, current_subject: str = Depends(get_current_jwt_subject)
):
    """
...
@router.get("/status")
async def get_training_status(current_subject: str = Depends(get_current_jwt_subject)):
    """
...
async def get_training_metrics(current_subject: str = Depends(get_current_jwt_subject)):
    """
...
async def stream_training_progress(
    request: Request, current_subject: str = Depends(get_current_jwt_subject)
):
    """
