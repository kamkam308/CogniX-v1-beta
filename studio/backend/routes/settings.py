...
def get_upload_limit(current_subject: str = Depends(get_current_jwt_subject)) -> UploadLimitResponse:
...
def update_upload_limit(
    payload: UploadLimitPayload, current_subject: str = Depends(get_current_jwt_subject)
) -> UploadLimitResponse:
...
def update_helper_precache(
    payload: HelperPrecachePayload, current_subject: str = Depends(get_current_jwt_subject)
) -> HelperPrecacheResponse:
    _require_admin(current_subject)
    try:
...
def update_personalization_settings(
    payload: PersonalizationPayload, current_subject: str = Depends(get_current_jwt_subject)
