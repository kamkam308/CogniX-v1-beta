...
async def upload_dataset(
    file: UploadFile, current_subject: str = Depends(get_current_jwt_subject)
) -> UploadDatasetResponse:
...
def check_format(request: CheckFormatRequest, current_subject: str = Depends(get_current_jwt_subject)):
...
def ai_assist_mapping(
    request: AiAssistMappingRequest, current_subject: str = Depends(get_current_jwt_subject)
):
