...
async def get_scan_folders(current_subject: str = Depends(get_current_jwt_subject)):
...
async def add_scan_folder_endpoint(
    body: AddScanFolderRequest, current_subject: str = Depends(get_current_jwt_subject)
):
...
async def remove_scan_folder_endpoint(
    folder_id: int, current_subject: str = Depends(get_current_jwt_subject)
):
...
async def get_recommended_folders(current_subject: str = Depends(get_current_jwt_subject)):
...
@router.get("/list")
async def list_models(current_subject: str = Depends(get_current_jwt_subject)):
...
async def discard_remote_code_download(
    model_name: str = Body(..., embed = True), current_subject: str = Depends(get_current_jwt_subject)
):
...
async def get_lora_base_model(lora_path: str, current_subject: str = Depends(get_current_jwt_subject)):
    """
...
async def list_cached_gguf(current_subject: str = Depends(get_current_jwt_subject)):
...
async def list_cached_models(current_subject: str = Depends(get_current_jwt_subject)):
