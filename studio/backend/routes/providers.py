...
async def get_public_key(current_subject: str = Depends(get_current_jwt_subject)):
...
async def list_registry(current_subject: str = Depends(get_current_jwt_subject)):
...
@router.get("/pricing")
async def get_pricing_snapshot(current_subject: str = Depends(get_current_jwt_subject)):
...
async def list_provider_configs(current_subject: str = Depends(get_current_jwt_subject)):
...
async def create_provider_config(
    payload: ProviderCreate, current_subject: str = Depends(get_current_jwt_subject)
):
...
async def delete_provider_config(
    provider_id: str, current_subject: str = Depends(get_current_jwt_subject)
):
...
async def test_provider(
    payload: ProviderTestRequest, current_subject: str = Depends(get_current_jwt_subject)
):
    """
...
async def list_provider_models(
    payload: ProviderModelsRequest, current_subject: str = Depends(get_current_jwt_subject)
):
    """
