...
async def upload_dataset(
    file: UploadFile, current_subject: str = Depends(require_admin_subject)
) -> UploadDatasetResponse:
...
async def list_cached_datasets(current_subject: str = Depends(require_admin_subject)):
...
async def delete_cached_dataset(
    repo_id: str = Body(..., embed = True), current_subject: str = Depends(require_admin_subject)
):
...
async def cancel_dataset_download(
    body: CancelDatasetDownloadRequest, current_subject: str = Depends(require_admin_subject)
):
